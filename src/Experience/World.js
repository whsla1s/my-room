...
export default class World
{
    ...
    setScreens()
    {
        // 1. Obtemos a malha da tela do PC (o objeto que queremos clicar)
        const pcScreenMesh = this.resources.items.pcScreenModel.scene.children[0];

        // 2. Atribuímos o nome para o Raycasting
        pcScreenMesh.name = 'projects_trigger'; 
        
        // OPCIONAL: Para confirmar no console
        console.log('Objeto nomeado para Raycasting:', pcScreenMesh.name);


        this.pcScreen = new Screen(
            pcScreenMesh, // Usamos a malha que acabamos de nomear
            '/assets/shine.mp4'
        )
